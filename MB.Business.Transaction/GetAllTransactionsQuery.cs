...
{
    public class GetAllTransactionsQuery : IQuery<List<Data.Entities.Transaction>>, ICanCount, ICanTop, ICanSkip, ICanExpand, ICanOrderBy, ICanFilter<Data.Entities.Transaction>
    {
